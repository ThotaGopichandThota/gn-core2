//go:generate protoc -I=. -I=$GOPATH/src/github.com/ThotaGopichandThota/gn-core2/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/gn-core2/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
