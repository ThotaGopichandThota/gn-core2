//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/gn-core2/protobuf/protobuf  --gogoslick_out=. scheduled.proto
package scheduled

import (
	"github.com/ThotaGopichandThota/gn-core2/data"
	"github.com/ThotaGopichandThota/gn-core2/data/block"
	"github.com/ThotaGopichandThota/gn-core2/data/smartContractResult"
	"github.com/ThotaGopichandThota/gn-core2/data/transaction"
)
