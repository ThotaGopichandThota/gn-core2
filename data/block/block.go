//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/gn-core2/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/ThotaGopichandThota/gn-core2/data/headerVersionData"
)
